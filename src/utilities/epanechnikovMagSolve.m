function [rho,ferror,niter,iflagterm] = epanechnikovMagSolve(x,n)
%
...
%
%  for an x in the range 0 <= x <= 1 to produce a rho in this range. 
%  n must be an integer.
%
%  This function is a utility for use in sampling a Epanechnikov
%  distribution.  If x is sampled from a uniform distribution on the
%  interval from 0 to 1, then rho will be the magnitude of a sample from an
%  Epanechnikov kernel distribution in a space of dimension n.
%
